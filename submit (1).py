...
clf = LogisticRegression(C = 1000, tol=1e-4)


# clf = make_pipeline(StandardScaler(),
#                     LinearSVC(dual="auto", random_state=0, tol=1e-30))
...
################################
    ...
    b = clf.intercept_[0]
    # w = clf.named_steps['linearsvc'].coef_[0]  # Access the coefficients via the named_steps attribute
